...
Group.new('MatchParen', nil, colors.background, styles.NONE)
Group.new('NonText', colors.background, nil, styles.NONE)
Group.new('Whitespace', colors.background, nil, styles.NONE)
...
Group.new('StatusLineNC', colors.grey, colors.background, styles.NONE)
Group.new('StatusLineTermNC', colors.grey, colors.background, styles.NONE)
Group.new('TabLine', colors.foreground, colors.background, styles.NONE)
Group.new('TabLineFill', colors.grey, colors.background, styles.NONE)
...
-- Group.new('Visual', nil, colors.background, styles.NONE)
