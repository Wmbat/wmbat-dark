...
Group.new('ErrorText', colors.diff_red, nil, styles.undercurl)
Group.new('WarningText', colors.diff_yellow, nil, styles.undercurl)
Group.new('InfoText', colors.diff_blue, nil, styles.undercurl)
Group.new('HintText', colors.diff_green, nil, styles.undercurl)
...
Group.new('ErrorFloat', colors.red, nill, styles.NONE)
Group.new('WarningFloat', colors.yellow, nill, styles.NONE)
Group.new('InfoFloat', colors.blue, nill, styles.NONE)
Group.new('HintFloat', colors.green, nill, styles.NONE)

Group.new('VirtualTextError', colors.red, nill, styles.NONE)
Group.new('VirtualTextWarning', colors.yellow, nill, styles.NONE)
Group.new('VirtualTextInfo', colors.blue, nill, styles.NONE)
Group.new('VirtualTextHint', colors.green, nill, styles.NONE)
