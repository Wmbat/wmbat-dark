...
Group.new('SpellBad', nil, nil, styles.undercurl, colors.red)
Group.new('SpellCap', nil, nil, styles.undercurl, colors.yellow)
Group.new('SpellLocal', nil, nil, styles.undercurl, colors.blue)
Group.new('SpellRare', nil, nil, styles.undercurl, colors.purple)
...
Group.new('ErrorText', nil, nil, styles.undercurl, colors.red)
Group.new('WarningText', nil, nil, styles.undercurl, colors.yellow)
Group.new('InfoText', nil, nil, styles.undercurl, colors.blue)
Group.new('HintText', nil, nil, styles.undercurl, colors.green)
...
Group.new('TSURI', colors.green, nil, styles.underline)
