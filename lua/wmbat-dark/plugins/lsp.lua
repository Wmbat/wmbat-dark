...
local group = lush(function()
	return {
		...
		LspDiagnosticsFloatingError { LspDiagnosticDefaultError },
		LspDiagnosticsFloatingWarn { LspDiagnosticDefaultWarn },
		LspDiagnosticsFloatingInfo { LspDiagnosticDefaultInfo },
		LspDiagnosticsFloatingHint { LspDiagnosticDefaultHint },

		LspDiagnosticsVirtualTextError { LspDiagnosticDefaultError },
		LspDiagnosticsVirtualTextWarn { LspDiagnosticDefaultWarn },
		LspDiagnosticsVirtualTextInfo { LspDiagnosticDefaultInfo },
		LspDiagnosticsVirtualTextHint { LspDiagnosticDefaultHint },
		...
		LspDiagnosticsSignError { LspDiagnosticDefaultError },
		LspDiagnosticsSignWarn { LspDiagnosticDefaultWarn },
		LspDiagnosticsSignInfo { LspDiagnosticDefaultInfo },
		LspDiagnosticsSignHint { LspDiagnosticDefaultHint },
