...
local theme = lush(function(injected_functions)
	...
	return {
		...
		LspSignatureActiveParameter { gui = styles.invert_selection } , -- Used to highlight the active parameter in the signature help. See |vim.lsp.handlers.signature_help()|.
